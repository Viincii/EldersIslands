<?php 
	class VueComposantMenu{
		...
		function __construct(){
			$this->menu = "<div id='blockMenu'><a href=index.php?module=Lore><img class='menu' src='Image/lore.png' alt=''>
			...
			<a href=index.php?module=Patchs><img class='menu' src='Image/Patch.png' alt=''></a></div>";
		}
