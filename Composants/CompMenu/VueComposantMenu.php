	...
	class VueComposantMenu{
      ...
      <div class='iconeMenu'><a href=index.php?module=Lore class='lienMenu'><p class='textMenu'>Lore</p></a></div>
			...
			if(!isset($_SESSION['id'])){
				echo "
				<div class='iconeMenu'><a href=index.php?connexion&action=bienvenue class='lienMenu'><p class='textMenu'>Deck</p></a></div>
		  	<div class='iconeMenu'><a href=index.php?connexion&action=bienvenue class='lienMenu'><p class='textMenu'>Jouer</p></a></div>
			  <div class='iconeMenu'><a href=index.php?connexion&action=bienvenue class='lienMenu'><p class='textMenu'>Ligue</p></a></div>
			  <div class='iconeMenu'><a href=index.php?connexion&action=bienvenue class='lienMenu'><p class='textMenu'>Guilde</p></a></div>
				";
			}else{
				echo "
