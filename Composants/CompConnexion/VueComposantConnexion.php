	...
	class VueComposantConnexion{
		...
		function __construct(){
			$this->menu = ((!isset($_SESSION['id'])) ?
			 ...
			 :(($_GET['module']!='profil')?"<div id='miniProfil'><a href=index.php?module=profil><img src=".$_SESSION['avatar']." id=miniAvat><div id='miniPseudo'>".$_SESSION['id']."</div></a></br>"."<a href=index.php?module=connexion&action=deco><button class='butP'>Deconnexion</button></a></br></div>":''));
		}
